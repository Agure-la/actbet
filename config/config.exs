...
config :actbet,
  ecto_repos: [Actbet.Repo],
  generators: [timestamp_type: :utc_datetime]

config :actbet, Actbet.Repo,
  migration_primary_key: [name: :id, type: :integer],  # default
  migration_foreign_key: [type: :integer]              # default
...
config :actbet, ActbetWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ActbetWeb.ErrorHTML, json: ActbetWeb.ErrorJSON],
    layout: false
  ],
...
config :actbet, Actbet.Mailer, adapter: Swoosh.Adapters.Local
