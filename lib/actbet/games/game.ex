defmodule Actbet.Games.Game do
  ...
  @derive {Jason.Encoder, only: [:id, :home_team, :away_team, :start_time, :status, :inserted_at, :updated_at, :bet_odds]}
  schema "games" do
  ...
  def changeset(game, attrs) do
    game
    |> cast(attrs, [:home_team, :away_team, :start_time, :result, :status, :bet_odds])
    |> validate_required([:home_team, :away_team, :start_time])
